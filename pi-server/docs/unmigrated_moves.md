...
_Generated by generate_unmigrated_moves.py against DnD_moves_categorized_draft.json -- 888 moves total, 427 with no `effects` array yet.
...
### heal_self (4) -- heals the user
- Burning Glance
- Purify
- Refresh
- Strength Sap

### conditional_damage (1) -- damage that scales on a condition -- 17 of 32 already have a damage_note reminder (see migrate_effects_v22/v23/v24.py and earlier), these are the rest
- Stored Power
