...
_Generated by generate_unmigrated_moves.py against DnD_moves_categorized_draft.json -- 888 moves total, 434 with no `effects` array yet.
...
## 2. Needs a new effect kind / mechanism (130)
...
### conditional_damage (7) -- damage that scales on a condition -- 17 of 32 already have a damage_note reminder (see migrate_effects_v22/v23/v24.py and earlier), these are the rest
- Archive Blast
- Formation Strike
- Self-Destruct
- Solar Beam
