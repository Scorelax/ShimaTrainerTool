...
_Generated by generate_unmigrated_moves.py against DnD_moves_categorized_draft.json -- 888 moves total, 452 with no `effects` array yet.
...
## 4. Pure mechanical shape -- correctly has no `effects`, nothing to do (257)
